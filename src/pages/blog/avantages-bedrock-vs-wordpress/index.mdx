...
export const meta = {
    ...
    title: "Les avantages de Bedrock comparé à WordPress",
    date: "2021-01-04",
...
Dans cet article nous allons découvrir ensemble le _boilerplate_ **Bedrock** ansi que ses nombreux **avantages** et pourquoi privilégier ce fonctionnement à du _Vanilla_ WordPress (installation WordPress classique).
