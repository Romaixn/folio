...
import logoEwill from '@/images/logos/ewill.png'
import logoKrealab from '@/images/logos/krealab.png'
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Romain Herault - Web developer and amateur 3D artist
        </title>
        <meta
          name="description"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://phpc.social/web/@rherault"
            ...
            />
            <SocialLink
              href="https://linkedin.com/in/romain-herault"
