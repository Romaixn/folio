  ...
  return (
    <Layout>
      ...
      <div className="pb-16">
        ...
        ></div>
        <Container className="overflow-hidden bg-white pt-16 pb-20">
              ...
              <div className="relative md:bg-white md:py-6">
                <div className="lg:grid lg:grid-cols-2 lg:gap-6">
                  <div className="prose prose-lg prose-red text-gray-500 lg:max-w-none">
                    <p>
                      Hey 👋🏻 ! Moi c'est <strong>Romain</strong>, passionné par
                      les nouvelles technologies et leurs facultés à améliorer
                      nos vies.
                    </p>
                    <p>
                      Je suis <strong>développeur web orienté backend</strong>{' '}
                      mais "touche à tout" (d'où le <strong>fullstack</strong>)
                      ! J'apprécie plus particulièrement{' '}
                      <strong>Symfony</strong> et <strong>WordPress</strong>{' '}
                      combiné avec <strong>Tailwind CSS</strong> (❤️) pour créer
                      de magnifiques sites performants.
                    </p>
                    <p>
                      Être fier de mon code est une véritable philosophie de
                      vie, j'en parle{' '}
                      <Link href="/blog/devenir-meilleur-developpeur-clean-code">
                        ici
                      </Link>
                      . C'est pour cela que je m'intéresse de plus en plus aux{' '}
                      <strong>architectures de codes modernes</strong> et aux
                      principes liés au "<strong>Clean Code</strong>" (SOLID,
                      DDD, etc..)
                    </p>
                    <p>
                      Diplômé d'une Licence Professionnelle Web et Mobile à
                      l'IUT d'Orléans à la suite d'un DUT Informatique, je n'ai
                      cessé de me former davantage depuis.
                    </p>
                  </div>
                  <div className="prose prose-lg prose-red mt-6 text-gray-500 lg:mt-0">
                    <p>
                      Je peux vous aider à <strong>réaliser un projet</strong>{' '}
                      dans toutes ses étapes de la conception :
                    </p>
                    <ol role="list">
                      <li>
                        Analyse du cahier des charges et choix des technologies
                      </li>
                      <li>Développement</li>
