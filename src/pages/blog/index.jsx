          ...
          <div>
            ...
            <div className="mt-3 sm:mt-4 lg:grid lg:grid-cols-2 lg:items-center lg:gap-5">
              <p className="text-xl text-gray-500">
                Inscris-toi pour recevoir ma <a className="text-red-600" href="https://www.getrevue.co/profile/rherault" target="_blank" rel="noopener noreferrer">veille technologique</a>, toutes les
